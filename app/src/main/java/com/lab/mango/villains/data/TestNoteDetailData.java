        ...
        switch (noteId) {
            case 0:
                ...
                notes.add(new NoteDetail(noteId, "문제 #1"
                        , "개신남"
                        , 0
                        , "QUESTION_TYPE_EDITTEXT QUESTION_TYPE_EDITTEXT"
                        , youtubeUrl, false, true, Const.QUESTION_TYPE_EDITTEXT, "test"));
                ...
                notes.add(new NoteDetail(noteId, "문제  #2"
                        , "라스베가스 벨라지오 호텔 분수쇼"
                        , 1
                        , "QUESTION_TYPE_PATTERN QUESTION_TYPE_PATTERN"
                        , youtubeUrl, false, true, Const.QUESTION_TYPE_PATTERN, "test"));
                youtubeUrl = new ArrayList<>();
                ...
                notes.add(new NoteDetail(noteId, "문제  #3"
                        , "개기욤"
                        , 2
                        , "QUESTION_TYPE_NUMBER_PICKER QUESTION_TYPE_NUMBER_PICKER"
                        , youtubeUrl, false, true, Const.QUESTION_TYPE_NUMBER_PICKER, "test"));
                youtubeUrl = new ArrayList<>();
                ...
                notes.add(new NoteDetail(noteId, "문제  #4"
                        ...
                        , 3
                        , "QUESTION_TYPE_PATTERN QUESTION_TYPE_PATTERN"
                        , youtubeUrl, false, false, Const.QUESTION_TYPE_PATTERN, "test"));
                youtubeUrl = new ArrayList<>();
                ...
                notes.add(new NoteDetail(noteId, "문제  #5"
                        ...
                        , 4
                        , "QUESTION_TYPE_EDITTEXT QUESTION_TYPE_EDITTEXT"
                        , youtubeUrl, false, false, Const.QUESTION_TYPE_EDITTEXT, "test"));
                break;
            case 1:
                youtubeUrl = new ArrayList<>();
                ...
                notes.add(new NoteDetail(noteId, "루피 #1"
                        ...
                        , youtubeUrl, true, true, Const.QUESTION_TYPE_PATTERN, "test"));
                youtubeUrl = new ArrayList<>();
                ...
                notes.add(new NoteDetail(noteId, "루피 #2"
                        ...
                        , youtubeUrl, true, true, Const.QUESTION_TYPE_EDITTEXT, "test"));
                youtubeUrl = new ArrayList<>();
            ...
            default:
                ...
                notes.add(new NoteDetail(noteId, "추리 #1"
                        ...
                        , 25
                        , "유명한 사립 탐정 '코난' 납치?", youtubeUrl, true, true, Const.QUESTION_TYPE_EDITTEXT, "test"));
                youtubeUrl = new ArrayList<>();
                youtubeUrl.add("zbfjFtU-LjA");
                ...
                notes.add(new NoteDetail(noteId, "추리 #3"
                        ...
                        , 27
                        , "유명한 사립 탐정 '코난' 납치?", youtubeUrl, false, true, Const.QUESTION_TYPE_EDITTEXT, "test"));
                youtubeUrl = new ArrayList<>();
                youtubeUrl.add("zbfjFtU-LjA");
