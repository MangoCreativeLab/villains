        ...
        switch (noteId) {
            ...
            default:
                notes.add(new NoteDetail(noteId, "추리 #1"
                        ...
                        , 25
                        , "유명한 사립 탐정 '코난' 납치?", "zbfjFtU-LjA", true, true));
                ...
                notes.add(new NoteDetail(noteId, "추리 #3"
                        ...
                        , 27
                        , "유명한 사립 탐정 '코난' 납치?", "zbfjFtU-LjA", false, true));
